    ...
    <div class="main-content w-100">
        <nav class="navbar navbar-expand-lg navbar-light bg-white border-bottom px-4 py-3 shadow-sm">
            <div class="container-fluid px-0">
                ...
                <div class="ms-auto d-flex align-items-center"><span class="fw-semibold text-dark small"><i class="fas fa-user-circle me-1 fs-5 text-primary align-middle"></i>{{ Auth::user()->name ?? 'Administrator' }}</span></div>
            </div>
        </nav>
