...
return [
    ...
    'logo' => '<b>GNS</b> Network<br><small style="font-size:11px;font-weight:400;">Billing Management System</small>',
    'logo_img' => 'images/logo.png',
    'logo_img_class' => 'brand-image img-circle elevation-3',
    'logo_img_alt' => 'GNS Network',
    'auth_logo' => [
        'enabled' => false,
        'img' => ['path' => 'vendor/adminlte/dist/img/AdminLTELogo.png', 'alt' => 'Auth Logo', 'class' => '', 'width' => 50, 'height' => 50],
    ],
    'preloader' => [
        'enabled' => true,
        'mode' => 'fullscreen',
        'img' => ['path' => 'images/logo.png', 'alt' => 'GNS Network', 'effect' => 'animation__pulse', 'width' => 90, 'height' => 90],
    ],
    ...
    'menu' => [
        ...
        ['text' => 'Role Management', 'route' => 'roles.index', 'icon' => 'fas fa-user-shield', 'can' => 'role.view'],
        ['text' => 'Audit Trail', 'route' => 'audit.index', 'icon' => 'fas fa-history', 'can' => 'audit.view'],
